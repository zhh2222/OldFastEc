    ...
    protected void convert(MultipleViewHolder holder, MultipleItemEntity item) {
        ...
        switch (holder.getItemViewType()) {
            case OrderListItemType.ITEM_ORDER_LIST:
                ...
                final String titleValue = item.getField(MultipleFields.TITLE);
                final double priceValue = item.getField(OrderItemFields.PRICE);
                final String timeValue = item.getField(OrderItemFields.TIME);
