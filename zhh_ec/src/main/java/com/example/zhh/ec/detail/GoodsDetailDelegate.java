...
import com.example.zhh_ui.animation.BezierAnimation;
import com.example.zhh_ui.animation.BezierUtil;
import com.example.zhh_ui.banner.HolderCreator;
import com.example.zhh_ui.widget.CircleTextView;
 ...
 */
public class GoodsDetailDelegate extends ZhhDelegate implements AppBarLayout.OnOffsetChangedListener, BezierUtil.AnimationListener {
    ...
    private void initBanner(JSONObject data) {
        ...
        mBanner.setPages(new HolderCreator(), images).setPageIndicator(new int[]{R.drawable.dot_normal, R.drawable.dot_focus})
