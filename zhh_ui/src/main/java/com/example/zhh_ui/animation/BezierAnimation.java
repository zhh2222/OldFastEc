package com.example.zhh_ui.animation;
...
import com.example.zhh_ui.dimens.ScreenUtil;

public final class BezierAnimation {

    public static void addCart(ZhhDelegate delegate, View start, View end,
        ...
        final  int my = ScreenUtil.getScreenHeight(delegate.getContext()) / 10;
