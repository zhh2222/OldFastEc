package com.example.zhh_ui.widget;
...
public final class AutoPhotoLayout extends LinearLayoutCompat {
    ...
    public final void setDelegate(ZhhDelegate delegate) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(modeWith == MeasureSpec.EXACTLY ? sizeWith : width + getPaddingLeft() + getPaddingRight(),
